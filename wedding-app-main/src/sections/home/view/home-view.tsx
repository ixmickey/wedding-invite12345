...
import {
  ...
  CountdownTimer,
  VenueInformation,
  // Removed: EventSchedule,
  RSVP,
  // Removed: GalleryPreview,
  ClosingMessage,
  FloatingNavigation,
  NavigationFAB,
  MusicPlayer,
  ...
  if (showLetter) {
    return (
      <LetterAnimation
        ...
        // Swapped order to Groom & Bride (Fiqri & Mio)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50">
      ...
      <section id="couple" className="relative">
        {/* --- CHANGE: Pass the whole config object --- */}
        <CoupleIntroduction
          couple={WEDDING_CONFIG} // Pass the entire object
          isVisible={isLoaded}     // Keep isVisible if CoupleIntroduction uses it
        />
        {/* --- END CHANGE --- */}
      </section>
