...
export const WeddingDetailsCard = ({
  ...
  return (
    <div className="py-20 bg-gradient-to-br from-white to-rose-50/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6"> {/* Adjusted padding */}
        {/* Header */}
        <motion.div
        ...
        <motion.div
          ...
          className="relative bg-gradient-to-br from-white via-rose-50/30 to-pink-50/50 rounded-3xl shadow-2xl p-6 sm:p-10 md:p-12 mb-12 border border-rose-100/50 overflow-hidden group" // Adjusted padding p-6
        >
          ...
          <div className="relative z-10">
            ...
            {/* Date Display */}
            {/* --- CHANGE: Made tiny --- */}
            <div className="flex flex-row items-stretch justify-center gap-2 sm:gap-6 md:gap-10 mb-6"> {/* Changed flex-col to flex-row for base, adjusted gap/margin */}
            {/* --- END CHANGE --- */}
              ...
              >
                 {/* --- CHANGE: Made boxes and text tiny --- */}
                <div className="bg-gradient-to-br from-rose-500 to-pink-600 text-white rounded-lg sm:rounded-xl p-2 sm:p-4 shadow-md mb-1 h-12 sm:h-20 md:h-24 lg:h-28 flex flex-col items-center justify-center min-w-[48px] sm:min-w-[80px] md:min-w-[100px]">
                {/* --- END CHANGE --- */}
                  {/* --- CHANGE: Made text tiny --- */}
                  <div className="text-lg sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-none">
                  {/* --- END CHANGE --- */}
                    {date.getDate()}
                  </div>
                </div>
                {/* --- CHANGE: Made label tiny --- */}
                <p className="text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider mt-1"> {/* Tiny text, reduced margin */}
                {/* --- END CHANGE --- */}
                  {t('details.day')}
                </p>
              </motion.div>
              ...
              >
                {/* --- CHANGE: Made boxes and text tiny --- */}
                <div className="bg-gradient-to-br from-purple-500 to-indigo-600 text-white rounded-lg sm:rounded-xl p-2 sm:p-4 shadow-md mb-1 h-12 sm:h-20 md:h-24 lg:h-28 flex flex-col items-center justify-center min-w-[48px] sm:min-w-[80px] md:min-w-[100px]">
                {/* --- END CHANGE --- */}
                  {/* --- CHANGE: Made text tiny --- */}
                  <div className="text-base sm:text-xl md:text-2xl lg:text-3xl font-bold leading-none mb-0"> {/* Adjusted base size */}
                  {/* --- END CHANGE --- */}
                    {date
                      .toLocaleDateString(monthAbbrLocale, { month: 'short' })
                      .toUpperCase()}
                  </div>
                   {/* --- CHANGE: Made text tiny --- */}
              ...
              >
                {/* --- CHANGE: Made boxes and text tiny --- */}
                <div className="bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-lg sm:rounded-xl p-2 sm:p-4 shadow-md mb-1 h-12 sm:h-20 md:h-24 lg:h-28 flex flex-col items-center justify-center min-w-[48px] sm:min-w-[80px] md:min-w-[100px]">
                {/* --- END CHANGE --- */}
                  {/* --- CHANGE: Made text tiny --- */}
                  <div className="text-xs sm:text-base md:text-lg lg:text-xl font-bold leading-none"> {/* Adjusted base size */}
                  {/* --- END CHANGE --- */}
            ...
            {/* Weekday Display (remains the same) */}
            <motion.div
        ...
        {/* Additional Info (remains the same) */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div className="bg-gradient-to-r from-rose-50 to-pink-50 rounded-2xl p-8 border border-rose-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-xs sm:text-sm text-gray-600"> {/* Use grid-cols-1 on base */}
              ...
              <div className="flex flex-col items-center">
                ...
                <p>+91 99265 00186</p> {/* Updated Contact Number */}
              </div>
            </div>
          </div>
        </motion.div>
